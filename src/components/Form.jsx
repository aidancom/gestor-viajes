...
const Form = ({handleSubmit, formData, setFormData, travelsData, handleEdit, handleDelete, existingKey, valido}) => {

  const styledDivs = 'mx-5 border-[3px] border-[#9487F5] rounded-[10px] h-full'
  const formProps = {handleSubmit, styledDivs, formData, setFormData, existingKey, valido}
